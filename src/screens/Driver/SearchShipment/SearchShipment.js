...
const SearchShipment = ({ navigation }) => {
  useEffect(() => {
      ...
      <Header style={Styles.navigation}>
        ...
        <View style={Styles.nav}>
          <View style={Styles.navLeft}>
            ...
            >
              <Icon name="menu" type="MaterialIcons" style={Styles.navIcon} />
            </TouchableOpacity>
          </View>
        ...
        <View style={Styles.bgLayout}>
          <View style={Styles.hTop}>
            ...
            <View style={Styles.hContent}>
              <Text style={Styles.hTopText}>Search Shipment</Text>
              <Text style={Styles.hTopDesc}>2 results found</Text>
            </View>
          </View>
