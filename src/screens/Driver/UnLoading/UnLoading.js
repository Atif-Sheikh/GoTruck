...
const UnLoadingArea = ({ navigation }) => {
  useEffect(() => {
        ...
        <View style={Styles.bgLayout}>
          <View style={Styles.hTop}>
            ...
            <View style={Styles.hContent}>
              <Text style={Styles.hTopText}>UNLOADING AREA</Text>
              <Text style={Styles.hTopDesc}>Reached at : 27 June 2020</Text>
            </View>
          </View>
          ...
          <View style={Styles.tripItem}>
            ...
            <View style={Styles.msgBox}>
              <Text style={Styles.msgText}>
                UnLoading Person Name : Manikandan {"\n\n"}
                UnLoading Person Number : +91 9710950940
              </Text>
            </View>
