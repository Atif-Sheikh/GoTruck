        ...
        <View style={Styles.bgLayout}>
          <View style={Styles.hTop}>
            <Icon
              ...
              style={Styles.hImg}
            />
            <Text style={Styles.hTopText}>Reset password?</Text>
            <Text style={Styles.hTopDesc}>
              We just want to enter your new Password and confirm password to
              change.Don't Use the previous password.
            </Text>
          </View>
          <View style={Styles.regForm}>
            <View style={Styles.infoBox}>
              ...
              >
                <Text style={Styles.fBtnText}>Submit to Enter OTP</Text>
                <Icon
                  name="arrow-right"
                  type="FontAwesome"
